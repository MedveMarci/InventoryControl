...
public static class ApiManager
{
    ...
    {
        var name = InventoryControl.Singleton.Name;
        var currentVersion = InventoryControl.Singleton.Version;
    ...
    internal static string SendLogsAsync(string content)
    {
        try
        {
            var url = $"{ApiBase}/api/v1/plugin/{Uri.EscapeDataString(InventoryControl.Singleton.Name)}/log";
            ...
            {
                content,
                plugin_version = InventoryControl.Singleton.Version.ToString(),
