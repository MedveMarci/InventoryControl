...
internal static class LogManager
{
    ...
    public static void Debug(string message)
    {
        ...
        Logger.Raw($"[DEBUG] [{InventoryControl.Singleton.Name}] {message}", ConsoleColor.Green);
    }
    ...
    public static void Info(string message, ConsoleColor color = ConsoleColor.Cyan)
    {
        ...
        Logger.Raw($"[INFO] [{InventoryControl.Singleton.Name}] {message}", color);
    }
    ...
    public static void Error(string message, ConsoleColor color = ConsoleColor.Red)
    {
        ...
        Logger.Raw($"[ERROR] [{InventoryControl.Singleton.Name}] {message}", color);
    }
    ...
    public static (string logResult, bool success) GetLogHistory()
    {
        ...
        if (InventoryControl.Singleton.Config != null)
        {
            stringBuilder.AppendLine("\n--- Config ---\n");
            stringBuilder.Append($"{YamlConfigParser.Serializer.Serialize(InventoryControl.Singleton.Config)}");
        }
